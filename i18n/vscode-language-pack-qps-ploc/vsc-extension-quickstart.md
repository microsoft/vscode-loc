# Welcome to the Pseudo Language language pack
  ...
  ```json
        "contributes": {
            "localization": [{
                ...
                "localizedLanguageName": "Þƨèúδô £áñϱúáϱè ℓôřè"
            }]
        }
  ```
...
* Check out the `master` branch of the [VS Code repository](https://github.com/Microsoft/vscode).
  ...
  * If the language pack extension is placed next to the VS Code repository: `npm run update-localization-extension qps-ploc`
